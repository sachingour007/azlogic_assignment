      ...
      <div className="flex flex-col w-[32%] min-h-[400px]">
        ...
        <div className="flex flex-col shadow-lg border-[#e2e2e2] border p-2 bg-white rounded-lg mt-8">
          ...
          <div className="mt-3 p-2 flex justify-start gap-14 items-center text-sm text-[#979696]">
            <div className="flex items-center"><CalendarMonthOutlinedIcon style={{fontSize:"large"}}/><span className="ml-2">Start Time</span></div>
            <div className="flex items-center"><CalendarMonthOutlinedIcon style={{fontSize:"large"}}/><span className="ml-2">End Time</span></div>
          </div>
        </div>
        <button className="border-red-500 border mt-6 py-2 rounded-3xl text-white font-bold font-sans bg-gradient-to-r from-[rgb(222,38,48)] to-[rgb(244,12,89)]">Search</button>
      </div>
